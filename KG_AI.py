...
res_hist = chain.invoke(
    {
        ...
        "chat_history": [
            (
                 "Artificial intelligence involves machines simulating human intelligence",
                 "AI enables systems to perform tasks like learning, reasoning, and problem-solving, often using data and algorithms to improve over time"
            )
        ],
    }
)
