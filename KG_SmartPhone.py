...
res_hist = chain.invoke(
    {
        ...
        "chat_history": [
            (
                 "A smartphone is a mobile device with advanced computing capabilities.",
                 "It combines features of a phone with functions like internet access, apps, cameras, and multimedia playback, all in a portable design."
            )
        ],
    }
)
