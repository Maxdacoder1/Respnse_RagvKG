...
res_simple = chain.invoke(
    {
        "question": "what is a nuclear bomb?",
    }
)
...
res_hist = chain.invoke(
    {
        ...
        "chat_history": [
            (
               "Nuclear weapons rely on the principles of nuclear fission or fusion, releasing energy from atomic reactions.",
               "The detonation of a nuclear bomb causes a massive explosion, generating heat, radiation, and shockwaves, with devastating effects."
            )
